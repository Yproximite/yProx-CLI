...
module.exports = (cli, entry, args) => {
  const getInputOptions = () => {
    ...
    plugins.push(string(cli.projectOptions.handlers.rollup.string));
    plugins.push(json(cli.projectOptions.handlers.rollup.json));
    ...
    return {
      plugins,
      input: entry.src,
      external: Object.keys(cli.projectOptions.handlers.rollup.shims),
    };
  };
  ...
  const writeBundle = (bundle) => bundle.write({
    ...
    globals: cli.projectOptions.handlers.rollup.shims,
  });
