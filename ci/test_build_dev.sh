...
test -f public/css/containers.simple-array-entries.css
test ! -f public/css/containers.simple-array-entries.css.map
...
test   -f public/js/core-app-public.rollup.js
test ! -f public/js/core-app-public.rollup.js.map
